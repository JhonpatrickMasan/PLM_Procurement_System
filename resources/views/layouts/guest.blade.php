...
<head>
    ...
    <style>
        body {
            ...
            background-position: right; /* Position the background image */
        ...
        .header {
            ...
            font-weight: 600;
            margin-top: 10px;
            color: #4F74BB; /* Match the header color with the solid color background */
            margin-left: 35px;
        }
        .button {
        ...
        .divider {
            border: none;
            height: 1px;
            background: linear-gradient(to right, rgba(0,0,0,0), rgba(0,0,0,0.5), rgba(0,0,0,0)); /* Faded gradient */
    ...
    <div class="container">
        <div class="form-container">
            ...
            <div class="mt-6 px-6 py-4">
                ...
                <a href="#" class="button">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/4/44/Microsoft_logo.svg" alt="Microsoft Icon" width="24" height="24">
